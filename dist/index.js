...
(function (OfficeLocation) {
    ...
    OfficeLocation["KBP"] = "KBP";
    OfficeLocation["HRK"] = "HRK";
})(OfficeLocation = exports.OfficeLocation || (exports.OfficeLocation = {}));
var FetchStatusError = /** @class */ (function (_super) {
    __extends(FetchStatusError, _super);
    function FetchStatusError(message, response) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, fetch(requestUrl, requestOptions)];
                case 1:
                    resp = _a.sent();
